...
void nes6502_setcontext(nes6502_context *context)
{
   ...
   _memcpy(&cpu, context, sizeof(nes6502_context));
...
void nes6502_getcontext(nes6502_context *context)
{
   ...
   _memcpy(context, &cpu, sizeof(nes6502_context));
...
void nes6502_SetIRQ(int mask)
{
	cpu.int_pending |= mask;
}

void nes6502_ClrIRQ(int mask)
{
	cpu.int_pending &= ~mask;
}
